        ...
        <AdminLayout>
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="w-full flex items-center justify-start md:justify-end gap-2.5">
                    <button className="w-full md:w-fit px-6 py-1.5 border rounded-md flex items-center justify-center gap-2.5 bg-gray-950 hover:bg-gray-800 text-white duration-100">
